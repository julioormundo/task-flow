...
*(Adicione imagens ou GIFs da sua aplicação aqui)*

| Minhas Tarefas (Dashboard) | Modal de Cadastro / Edição |
| :---: | :---: |
| ![Dashboard](https://via.placeholder.com/450x250.png?text=TaskFlow+Dashboard) | ![Modal](https://via.placeholder.com/450x250.png?text=Modal+TaskDialog) |
...
├── app.py                 # Janela Principal e Gerenciador de Navegação (Sidebar)
